    ...
    if (options.fixtureEdit) {
      ...
      const worker = vm.exec(
        [
          ...
          "--offline",
          "--system-prompt",
          "Make the requested change in /workspace using the available tools. Do not commit, change Git history, or merely describe the edit. The host will run the required mise checks after you finish.",
          "--",
          launch.instruction,
        ],
        {
