...
```bash
pi install -l --approve git:github.com/tetienne/pi-lead@v0.1.2
```
...
```bash
npm pack
npm install --prefix /absolute/path/to/stage --ignore-scripts --omit=dev /absolute/path/to/pi-lead-0.1.2.tgz
